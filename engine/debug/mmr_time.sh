...
(cat $1_missing_messages.txt; grep -h "MissingMsg " $1_networkoutputs.txt; grep -HE "Send P2P.* $1 .*Missing Msg Response" fnode*_networkoutputs.txt) | gawk "$scriptVariable"
