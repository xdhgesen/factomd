	...
	for {
		...
		for i, peer := range fnode.Peers {
			...
			for j := 0; j < 100; j++ {
				...
				switch msg.Type() {
				case constants.MISSING_DATA, constants.MISSING_MSG, constants.MISSING_MSG_RESPONSE, constants.DBSTATE_MSG, constants.DBSTATE_MISSING_MSG, constants.DATA_RESPONSE:
