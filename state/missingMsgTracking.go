...
func (m *RecientMessage) Add(msg interfaces.IMsg) {
...
func (am *RecientMessage) GetAckAndMsg(DBHeight int, vmIndex int, height int, s interfaces.IState) (ack interfaces.IMsg, msg interfaces.IMsg) {
	heights := MsgHeight{DBHeight, vmIndex, height}
