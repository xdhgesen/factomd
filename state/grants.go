...
func GetHardCodedGrants() []HardGrant {
	...
	case "LOCAL":
		testAddress0 := "FA2s2SJ5Cxmv4MzpbGxVS9zbNCjpNRJoTX4Vy7EZaTwLq3YTur4u"
		testAddress1 := "FA2UEGEqpKEN85ffZrbFaXsoVQUbpfYikUimpguhMfqXgzpJfJHV"
		testAddress2 := "FA3nkFcswvtP6BQzVmMyTS5wEoaFKrPuKcGHvLtxXnHr6ruJvWT4"

		var oneFct uint64 = 100000000 // Factoshis

		hardcodegrants = []HardGrant{ // KLUDGE: try to add grants for a test address
			HardGrant{6, 1*oneFct, validateAddress(testAddress0)},
			HardGrant{11, 1*oneFct, validateAddress(testAddress0)},
			HardGrant{16, 1*oneFct, validateAddress(testAddress0)},

			HardGrant{6, 1*oneFct, validateAddress(testAddress1)},
			HardGrant{11, 1*oneFct, validateAddress(testAddress1)},
			HardGrant{16, 1*oneFct, validateAddress(testAddress1)},

			HardGrant{6, 1*oneFct, validateAddress(testAddress2)},
			HardGrant{11, 1*oneFct, validateAddress(testAddress2)},
			HardGrant{16, 1*oneFct, validateAddress(testAddress2)},

			// ----------- //

			HardGrant{21, 1*oneFct, validateAddress(testAddress0)},
			HardGrant{26, 1*oneFct, validateAddress(testAddress0)},
			HardGrant{31, 1*oneFct, validateAddress(testAddress0)},

			HardGrant{21, 1*oneFct, validateAddress(testAddress1)},
			HardGrant{26, 1*oneFct, validateAddress(testAddress1)},
			HardGrant{31, 1*oneFct, validateAddress(testAddress1)},

			HardGrant{21, 1*oneFct, validateAddress(testAddress2)},
			HardGrant{26, 1*oneFct, validateAddress(testAddress2)},
			HardGrant{31, 1*oneFct, validateAddress(testAddress2)},

			// ----------- //

			HardGrant{36, 1*oneFct, validateAddress(testAddress0)},
			HardGrant{41, 1*oneFct, validateAddress(testAddress0)},
			HardGrant{46, 1*oneFct, validateAddress(testAddress0)},

			HardGrant{36, 1*oneFct, validateAddress(testAddress1)},
			HardGrant{41, 1*oneFct, validateAddress(testAddress1)},
			HardGrant{46, 1*oneFct, validateAddress(testAddress1)},

			HardGrant{36, 1*oneFct, validateAddress(testAddress2)},
			HardGrant{41, 1*oneFct, validateAddress(testAddress2)},
			HardGrant{46, 1*oneFct, validateAddress(testAddress2)},
		}
	case "CUSTOM":
