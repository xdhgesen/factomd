...
func GetHardCodedGrants() []HardGrant {
	...
	case "LOCAL":
		hardcodegrants = []HardGrant{
			...
			HardGrant{11, 3000e8, validateAddress("FA3QcDsGS2pK6LDuqCuA2i1sRVeH59PhdHPeQ6bneMDj7ZAqbsZg")},

			// FACTOM-GRANT-FACTOM-MARKETING-COMMITTEE-003
			// Factom Protocol Marketing Committee - Hackathon Grant
			HardGrant{11, 3600e8, validateAddress("FA2pdi4o4qJd2y7ygHbyvJTk6oXrPLJvH27zdLZrUkmc9gT6Mpca")},
			// --------------------------------------------------------
			...
			HardGrant{11, 4276e8, validateAddress("FA2feHES9FUQwSDYHeGT8UasUKAPNb91fMDTi7qqpXqHedrKyDwv")},

			// FACTOM-GRANT-EXCHANGE-COMMITTEE-003
			// Exchange Committee Funding (2019-1 round)
			HardGrant{11, 5000e8, validateAddress("FA2feHES9FUQwSDYHeGT8UasUKAPNb91fMDTi7qqpXqHedrKyDwv")},
			// --------------------------------------------------------

			// Core Development

			// Factom Inc, Protocol Development Continuation 009 Dec 9 2018 - Mar 9 2019
			HardGrant{11, 27440e8, validateAddress("FA3LwCDE3ZdFkr9nE1Keb5JcHgwXVWpEHydshT1x2qKFdvZELVQz")},
			// Sponsor 1, Dominic Luxford -- 600 FCT
			HardGrant{11, 600e8, validateAddress("FA27Y2fEsaBPeFsN87czeZxLsA9fxi3fcy4f4xHXdF58W7TgbaCB")},
			// Sponsor 2, Nolan Bauer -- 600 FCT
			HardGrant{11, 600e8, validateAddress("FA2oecgJW3XWnXzHhQQoULmMeKC97uAgHcPd4kEowTb3csVkbDc9")},
			// Sponsor 3, Factomatic -- 600 FCT
			HardGrant{11, 600e8, validateAddress("FA2944TXTDQKdJDp3TLSANjgMjwK2pQnTSkzE3kQcHWKetCCphcH")},
			// Transition assistent, Nic Robinette -- 200 FCT
			HardGrant{11, 200e8, validateAddress("FA2TDwdBLoCtEKrWqf7gSDhXzw8F5GLTK2wFLgg3erC1Ms6jBWuk")},
			// --------------------------------------------------------

			// Factom Inc, Protocol Development 012 Mar 9 2019 - Jun 9 2019
			HardGrant{11, 35459e8, validateAddress("FA3LwCDE3ZdFkr9nE1Keb5JcHgwXVWpEHydshT1x2qKFdvZELVQz")},
			// Sponsor 1, Dominic Luxford -- 600 FCT
			HardGrant{11, 600e8, validateAddress("FA27Y2fEsaBPeFsN87czeZxLsA9fxi3fcy4f4xHXdF58W7TgbaCB")},
			// Sponsor 2, Nolan Bauer -- 600 FCT
			HardGrant{11, 600e8, validateAddress("FA2oecgJW3XWnXzHhQQoULmMeKC97uAgHcPd4kEowTb3csVkbDc9")},
			...
			HardGrant{11, 6000e8, validateAddress("FA3XkRCucFVp2ZMnY5uSkxrzKojirkeY6KpwkJyNZPRJ4LsjmFDp")},
			// --------------------------------------------------------

			// FACTOM-GRANT-LAYERTECH-001
			// LayerTech, Core Code Development Grant
			HardGrant{11, 5500e8, validateAddress("FA2qGCTMiufU1cStopyx3NbNwG1Sawpo8MM9icvKXouzA6mSsFbA")},
			// --------------------------------------------------------

			// FACTOM-GRANT-BIF-004 BIF
			// BIF, Core Code Development Grant
			HardGrant{11, 500e8, validateAddress("FA2YFZrZkywe1TvSrsWCaZ5RyJ1ZXcN5a2x9WqCRobj5GQawpTNt")},
			// --------------------------------------------------------
			...
			// De Facto
			HardGrant{11, 6980e8, validateAddress("FA2rrwFVvkFYwyGFHVBMwRqTpycuZiagrQdcbPWzuoEwJQxjDwi3")},
			// Jay Cheroske (Bedrock Solutions)
			HardGrant{11, 400e8, validateAddress("FA2FqYZPfBeRWq7fWSFEhassT5zpMQZm8jwus3yWbzeN3PZPWybm")},
			// --------------------------------------------------------
			...
			HardGrant{11, 13625e6, validateAddress("FA2FqYZPfBeRWq7fWSFEhassT5zpMQZm8jwus3yWbzeN3PZPWybm")},
			// De Facto -- 136.25 FCT
			HardGrant{11, 13625e6, validateAddress("FA2YeMbN8Z1SsT7Yqw6Np85kWwtFVg2CyJKMDFnuXTawWuWPtzvX")},
			// CryptoLogic -- 136.25 FCT
			HardGrant{11, 13625e6, validateAddress("FA29wMUjN38BVLbJs6dR6gHHdBys2mpo3wy565JCjquUQTGqNZfb")},
			// TFA -- 136.25 FCT
			HardGrant{11, 13625e6, validateAddress("FA2LV4s7LKA9BTgWaJNvcr9Yq8rpiH2XD3vEPY3nwSiNSrnRgkpK")},
			// --------------------------------------------------------

			// BEDROCK-DEFACTO-001
			// Factom Open Node Enhancement -- 374 FCT total
			// Bedrock Solutions -- 172 FCT
			HardGrant{11, 172e8, validateAddress("FA2FqYZPfBeRWq7fWSFEhassT5zpMQZm8jwus3yWbzeN3PZPWybm")},
			// De Facto -- 172 FCT
			HardGrant{11, 172e8, validateAddress("FA2YeMbN8Z1SsT7Yqw6Np85kWwtFVg2CyJKMDFnuXTawWuWPtzvX")},
			// CryptoLogic -- 30 FCT
			HardGrant{11, 30e8, validateAddress("FA29wMUjN38BVLbJs6dR6gHHdBys2mpo3wy565JCjquUQTGqNZfb")},
			// --------------------------------------------------------
			...
			HardGrant{11, 682e8, validateAddress("FA3iRzBGA78gkkJ88PinKi3wwNfBhyoGExgzYx9btJZqo5or1o5A")},
			// --------------------------------------------------------
			...
			HardGrant{11, 500e8, validateAddress("FA3XkRCucFVp2ZMnY5uSkxrzKojirkeY6KpwkJyNZPRJ4LsjmFDp")},
			// --------------------------------------------------------
			...
			// DBGrow -- 5.500 FCT
			HardGrant{11, 5500e8, validateAddress("FA3HSuFo9Soa5ZnG82JHqyKiRi4Pw17LxPTo9AsCaFNLCGkXkgsu")},
			// Luciap -- 3.200 FCT
			HardGrant{11, 3200e8, validateAddress("FA3DikVW7pzhMkJXuP9xszf9o3aKrMHqEpPkLee2Nb6WewhupyM8")},
			// Canonical Ledgers -- 4.000 FCT
			HardGrant{11, 4000e8, validateAddress("FA2nBeBX75R7ECdhZS61DLpP5apaS32zwSYQ7aRkahwAjy5bryFo")},
		}
	case "CUSTOM":
		hardcodegrants = []HardGrant{}
