...
func (s *State) Init() {
	...
	s.apiQueue = NewAPIQueue(1000)                                         //incoming message queue from the API
	s.ackQueue = make(chan interfaces.IMsg, 1000)                          //queue of Leadership messages
	s.msgQueue = make(chan interfaces.IMsg, constants.INMSGQUEUE_HIGH+100) //queue of Follower messages
